"""this test case To verify Login functionality with email field entered max characters."""
import unittest
...
class TestData(object):
    """foo"""
    email = "karmanmansourmohamedalihossam1123243561195676000140@cs.modern-academy.edu.eg"
